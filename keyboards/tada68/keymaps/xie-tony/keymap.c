...
/* Function layer when held, Numpad 5 when tapped */
#define FL_P5 LT(_FL, KC_P5)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_65_ansi(
        ...
        FL_P5 ,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP,
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______,          KC_PSCR, KC_HOME,
        _______,          KC_BRID, KC_BRIU, BL_TOGG,  BL_DEC, BL_INC,  _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, _______, KC_END,
